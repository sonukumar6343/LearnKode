...
//       {/* Mobile Menu */}
//       {mobileMenuOpen && (
//         <div className="absolute top-14 left-0 z-[1000] w-full bg-richblack-800 text-richblack-25 md:hidden">
//           <nav>
...
//                         </div>
//                         {catalogOpen && (
//                           <div className="mt-2 flex flex-col gap-2 rounded-lg bg-richblack-5 p-4 text-richblack-900">
//                             {loading ? (
//                               <p className="text-center">Loading...</p>
//                             ) : subLinks.length ? (
//                               <>
